          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <p className="text-lg text-white/70 max-w-2xl mx-auto mb-12">
                We're excited to help you build a powerful enterprise solution with our Enterprise Website Package.
              </p>
              ...
              >
                <Card className="p-8 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm">
                  ...
                  <p className="text-white/70 mb-6 max-w-2xl mx-auto">
                    Check out these resources to learn more about our enterprise development process:
                  </p>
