  ...
  return (
    <div className="bg-[#0F0F0F] min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Thank you for choosing our Enterprise Package. While you wait, access our exclusive enterprise-level digital transformation guide." />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white leading-tight tracking-tight mb-6">
                Welcome to Enterprise-Level
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00f2fe] to-[#ff00e5]"> Excellence</span>
              </h1>
              <p className="text-xl text-white/70 mb-8">
                Thank you for choosing our Enterprise Package. Our senior team will contact you within 24 hours to begin planning your digital transformation.
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-4">
                Access Your Enterprise Resource Pack
              </h2>
              <p className="text-white/70 mb-6">
                Get our comprehensive "Enterprise Digital Transformation Guide" covering scalability, security, and integration strategies.
              </p>
              ...
              {!isSuccess ? (
                ...
                <div className="text-white text-center p-4">
                  Check your email for your enterprise resource pack!
                </div>
              )}
            </motion.div>
            ...
            >
              <p className="text-white/70">
                Have questions? Contact your dedicated account manager or email us at{' '}
