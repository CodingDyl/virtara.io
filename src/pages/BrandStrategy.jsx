...
const BrandStrategy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Brand Strategy Services | Digital Brand Development</title>
        <meta name="description" content="Develop a powerful brand strategy that resonates with your audience. Our brand development services help you stand out in the digital landscape." />
        <meta name="keywords" content="brand strategy, brand development, digital branding, brand identity, brand consulting" />
        <link rel="canonical" href="https://virtara.co.za/brand-strategy" />
      </Helmet>
